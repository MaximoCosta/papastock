      ...
      <main className="app-main ml-[236px] min-h-screen px-7 pb-12 pt-[86px] max-[900px]:ml-[76px]">
        <div className="mx-auto max-w-[1580px]">
          {isLoading ? (
            ...
            <>
              <div className={`mb-4 flex items-center justify-between border px-3 py-2 text-[10px] ${dataWarning ? 'border-[#e2c88e] bg-[#fff8e8] text-[#785716]' : 'border-[#c6d7c9] bg-[#eff5ef] text-[#365b42]'}`} role={dataWarning ? 'status' : undefined}>
              ...
              {actionError && (
                <div className="mb-4 flex items-center justify-between border border-[#dfaaa4] bg-[#fdf0ee] px-3 py-2 text-[11px] text-[#81322d]" role="alert">
